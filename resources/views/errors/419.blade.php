...
<head>
  ...
  <title>Halaman Kedaluwarsa — PASIH</title>
...
<body class="bg-slate-50 text-slate-900 min-h-screen flex items-center justify-center p-4">
  <div class="w-full max-w-lg text-center space-y-6">
    ...
    {{-- Title --}}
    <div>
      <p class="text-sm font-semibold text-amber-600 tracking-wide uppercase">Error 419</p>
      <h1 class="mt-2 text-2xl font-bold text-slate-800 sm:text-3xl">Halaman Kedaluwarsa</h1>
    </div>

    {{-- Description --}}
    <p class="text-slate-600 leading-relaxed">
      Sesi Anda telah berakhir atau halaman ini terlalu lama terbuka.
