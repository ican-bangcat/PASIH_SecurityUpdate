...
<head>
  ...
  <title>File Terlalu Besar — PASIH</title>
...
<body class="bg-slate-50 text-slate-900 min-h-screen flex items-center justify-center p-4">
  <div class="w-full max-w-lg text-center space-y-6">
    ...
    {{-- Title --}}
    <div>
      <p class="text-sm font-semibold text-rose-600 tracking-wide uppercase">Error 413</p>
      <h1 class="mt-2 text-2xl font-bold text-slate-800 sm:text-3xl">File Terlalu Besar</h1>
    </div>

    {{-- Description --}}
    <p class="text-slate-600 leading-relaxed">
      Ukuran file yang Anda unggah melebihi batas maksimal yang diperbolehkan oleh server.
      Silakan kurangi ukuran file dan coba lagi.
    </p>

    {{-- Tips --}}
    <div class="rounded-xl bg-amber-50 ring-1 ring-amber-200 px-5 py-4 text-left text-sm text-amber-800">
      <p class="font-semibold mb-1.5">Tips:</p>
      <ul class="list-disc ml-4 space-y-0.5">
        <li>Pastikan ukuran file dokumen tidak melebihi <strong>5 MB</strong> (kecuali Peraturan Daerah maks. 20 MB).</li>
        <li>Gunakan format <strong>PDF, DOC, atau DOCX</strong> untuk dokumen.</li>
        <li>Untuk gambar, gunakan format <strong>JPG, PNG, atau WebP</strong>.</li>
      </ul>
    </div>
